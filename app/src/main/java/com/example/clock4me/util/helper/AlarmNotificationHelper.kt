package com.example.clock4me.util.helper
...
import com.example.clock4me.MainActivity
import com.example.clock4me.data.receiver.ACTION_DISMISS
import com.example.clock4me.data.receiver.ACTION_SNOOZE
import com.example.clock4me.data.receiver.AlarmBroadcastReceiver
import com.example.clock4me.util.GlobalProperties.pendingIntentFlags
import com.example.clock4me.util.setIntentAction
...
class AlarmNotificationHelper @Inject constructor(
    ...
    fun displayAlarmCheckerNotification() {
        val alarmCheckerNotification =
            NotificationCompat.Builder(applicationContext, ALARM_CHECKER_CHANNEL_ID)
                .setSmallIcon(R.drawable.baseline_alarm_24)
                .setShowWhen(false)
                .setOngoing(true)
                .build()
